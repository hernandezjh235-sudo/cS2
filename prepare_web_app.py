...
def main() -> int:
    ...
    try:
        ...
        status.update({"ok":True,"runtime_app":str(TARGET_APP),"runtime_version":"5.9.4","web_latency_layer":"5.8.4","premodel_context_layer":"5.8.5","verified_source_layer":"5.8.6","provider_recovery_layer":"5.8.7","authoritative_identity_layer":"5.8.8","completion_layer":"5.8.9","provider_discovery_layer":"5.9.0","hltv_context_layer":"5.9.1","verified_profile_layer":"5.9.2","hltv_map_layer":"5.9.3","direct_grading_layer":"5.9.4"})
